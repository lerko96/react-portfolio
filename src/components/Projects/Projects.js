		...
		<section id='projects'>
				...
				<div class='project__text'>
					...
					<div class='project__subtitle_small'>
						<time datetime='2021-08-20 12:00:00'>
							<i class='fa fa-calendar mr-2'></i>Fri, August 20th
							2021
						</time>
					</div>
					...
					<div class='project__info'>
						<p>
							...
							allows users to discover fishing locations in Ohio,
							as well as teach beginners how to get started
							fishing and the current regulations that are needed
							to follow. This project was built between a team of
							five in a completely remote environment with the
				...
				<div class='project__text'>
					...
					<div class='project__subtitle_small'>
						<time datetime='2021-07-23 12:00:00'>
							<i class='fas fa-calendar-alt mr-2'></i>Fri, July
							23rd 2021
						</time>
					</div>
					<div class='project__bar'></div>
					<div class='project__info'>
						<p>
							...
							that renders unique data from the MET Museum and
							NASA APIs each time you visit. We also built a local
							backend database to store historical information.
							This project was built between a team of four in a
							completely remote environemnt with the help of
			...
			<article class='project'>
				...
				<div class='project__text'>
					...
					<div class='project__info'>
						<p>
							Designed, built and tested a single page application
							that lets users make virtual donuts via clicking.
							Once enough donuts are made you have the ability to
							purchase upgrades such as auto-clickers and
				...
				<div class='project__text'>
					...
					<div class='project__subtitle_small'>
						<time datetime='2021-06-18 12:00:00'>
							<i class='fas fa-calendar-alt mr-2'></i>Fri, June
							18th 2021
						</time>
					</div>
					<div class='project__bar'></div>
					<div class='project__info'>
						<p>
							Designed, built and tested an MVC application that
							lets users discover treks located by continent,
							region and type. This project was built between a
							team of four in a completely remote environemnt with
			...
			<article class='project'>
				...
				<div class='project__text'>
					...
					<div class='project__info'>
						<p>
							Designed, built and tested a Java application for
							movie reviews.
						</p>
					</div>
					<ul class='project__tagbox'>
